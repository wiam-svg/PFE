...
//                   <button
//                     disabled
//                     className="px-4 py-2 cursour-pointeur text-white rounded-full bg-gradient-to-r from-red-500 to-indigo-600 hover:from-red-600 hover:to-indigo-700 font-medium transition-all hover:shadow-md flex items-center space-x-1"
//                   >
//                     <Plus className="w-4 h-4" />
//                     <span>Nouveau</span>
//                   </button>
    ...
    return (
      <header className={`${headerClass} border-b w-full shadow-sm`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Link href="/admin/dashboard" className="text-xl font-bold">
              {t('navbar.logo')} <span className="font-normal">{t('navbar.admin_subtitle')}</span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <span className="hidden md:inline-block text-sm">
              {t('navbar.user.admin_greeting', { name: `${prenom} ${nom}` })}
            </span>
    ...
    return (
      <header className={`${headerClass} border-b w-full shadow-sm`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Link href="/agent/dashboard" className="text-xl font-bold">
              {t('navbar.logo')} <span className="font-normal">{t('navbar.agent_subtitle')}</span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <span className="hidden md:inline-block text-sm">
              {t('navbar.user.agent_greeting', { name: `${prenom} ${nom}`, zone: zone || ville })}
            </span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <div className="relative">
                ...
                >
                  <MapPin className="w-4 h-4" />
                  <span>{t('navbar.links.reports')}</span>
                  <ChevronDown className={`w-4 h-4 ml-1 transition-transform ${signalementMenuOpen ? 'rotate-180' : ''}`} />
                </button>
                ...
                {signalementMenuOpen && (
                  <div className="absolute left-0 mt-2 w-56 py-2 bg-white rounded-xl shadow-lg z-10 border border-gray-100 animate-fadeIn">
                    <Link
                      ...
                      onClick={() => setSignalementMenuOpen(false)}
                    >
                      <span>{t('navbar.links.my_reports')}</span>
                      <ChevronRight className="w-4 h-4" />
                    </Link>
                    <Link
                      href="/signalements"
                      ...
                      onClick={() => setSignalementMenuOpen(false)}
                    >
                      <span>{t('navbar.links.all_reports')}</span>
                      <ChevronRight className="w-4 h-4" />
                    </Link>
                  </div>
                )}
              ...
              </Link>
              {
                auth.user.validated ?
                  ...
                  >
                    <Plus className="w-4 h-4" />
                    <span>{t('navbar.links.new_report')}</span>
                  </Link>
                  :
                  <button
                    disabled
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden md:inline-block text-sm font-medium text-gray-700">
                    {t('navbar.user.user_greeting', { name: prenom })}
                  </span>
                  <ChevronDown className="w-4 h-4 text-gray-500" />
                </button>
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-2 w-56 py-2 bg-white rounded-xl shadow-xl z-10 border border-gray-100 animate-fadeIn">
                    ...
                    <div className="py-1">
                      ...
                      >
                        <Settings className="w-4 h-4 mr-2 text-red-500" />
                        <span>{t('navbar.user.settings')}</span>
                      </Link>
                    </div>
