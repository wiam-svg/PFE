...
//   // Récupérer les données des props Inertia
//   const { stats } = usePage().props;
//   // إظهار البيانات في Console لمعرفة شكلها
//   console.log(stats.signalementsByCategory);
...
//                 <ResponsiveContainer width="100%" height="100%">
//                   <LineChart
//                     data={stats.signalementsByMonth} // Assurez-vous que la structure de `stats.signalementsByMonth` est correcte
//                     margin={{ top: 5, right: 30, left: 20, bottom: 5 }}
//                   >
//                     <CartesianGrid strokeDasharray="3 3" />
//                     <XAxis dataKey="month" />
...
//                 <ResponsiveContainer width="100%" height="100%">
//                   {/* <BarChart
//                     data={stats.signalementsByCategory} // تأكد من أن هذه هي البيانات التي تمثل الفئات وعدد الإشعارات
//                     layout="vertical"
//                     margin={{ top: 5, right: 30, left: 50, bottom: 5 }}
//                   >
//                     <CartesianGrid strokeDasharray="3 3" />
//                     <XAxis type="number" />
//                     <YAxis dataKey="category" type="category" /> {/* تعديل هذا ليتناسب مع "category" */}
//                   {/* <Tooltip />
//                     <Legend />
//                     <Bar
//                       dataKey="total_signalements" // تعديل هذا ليتناسب مع "total_signalements"
//                       name="Nombre"
//                       fill={COLORS.accent}
//                     />
//                   </BarChart> */}
...
//                   >
//                     <CartesianGrid strokeDasharray="3 3" />
//                     <XAxis dataKey="category" /> {/* الفئات أسفل */}
//                     <YAxis /> {/* الأرقام على اليسار */}
//                     <Tooltip />
//                     <Legend />
//                     <Bar
