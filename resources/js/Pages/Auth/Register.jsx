...
export default function RegisterForm() {
                ...
                <div className="flex items-center justify-between">
                    {[1, 2, 3].map((stepNumber) => (
                        <div key={stepNumber} className="flex flex-col items-center">
                            ...
                            <div className="text-xs text-gray-500">
                                {stepNumber === 1 && t('register.steps.personal_info')}
                                {stepNumber === 2 && t('register.steps.profile_type')}
                                {stepNumber === 3 && t('register.steps.finalization')}
                            </div>
                        </div>
                    ))}
                </div>
    ...
    return (
        <div className="max-w-3sl mx-auto p-8 bg-white rounded-sl shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel 
                                    htmlFor="nom" 
                                    value={t('register.form.personal_info.last_name')} 
                            ...
                            <div>
                                <InputLabel 
                                    htmlFor="prenom" 
                                    value={t('register.form.personal_info.first_name')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="prenom"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel 
                                    htmlFor="age" 
                                    value={t('register.form.personal_info.age')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="age"
                            ...
                            <div>
                                <InputLabel 
                                    htmlFor="telephone" 
                                    value={t('register.form.personal_info.phone')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="telephone"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel 
                                    htmlFor="email" 
                                    value={t('register.form.personal_info.email')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="email"
                            ...
                            <div>
                                <InputLabel 
                                    htmlFor="adresse" 
                                    value={t('register.form.personal_info.address')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="adresse"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel 
                                    htmlFor="ville" 
                                    value={t('register.form.personal_info.city')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="ville"
                            ...
                            <div>
                                <InputLabel 
                                    htmlFor="postal_code" 
                                    value={t('register.form.personal_info.postal_code')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="postal_code"
                ...
                {step === 2 && (
                    <div className="space-y-6">
                        <h2 className="text-xl font-semibold text-gray-700 mb-4">
                            {t('register.steps.profile_type')}
                        </h2>
                        
                        <div className="mb-6">
                            <InputLabel 
                                value={t('register.form.account_type')} 
                                className="text-gray-700 font-medium mb-3" 
                            />
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {[
                                    { value: 'entreprise', label: t('register.form.account_types.business'), icon: '🏢' },
                                    { value: 'citoyen', label: t('register.form.account_types.citizen'), icon: '👤' },
                                    { value: 'agent_municipal', label: t('register.form.account_types.municipal_agent'), icon: '🏛️' },
                                    { value: 'etudiant', label: t('register.form.account_types.student'), icon: '🎓' }
                                ].map(type => (
                                    <label 
                                        key={type.value}
                                        className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all duration-200 ${
                        ...
                        {formData.type === 'entreprise' && (
                            <div className="space-y-4 p-5 border border-red-200 rounded-lg bg-red-50">
                                <h3 className="font-medium text-red-800">
                                    {t('register.form.business_info.title')}
                                </h3>
                                <div>
                                    <InputLabel 
                                        htmlFor="nomEntreprise" 
                                        value={t('register.form.business_info.company_name')} 
                                        className="text-gray-700 font-medium" 
                                    />
                                    <TextInput
                                        id="nomEntreprise"
                                ...
                                <div>
                                    <InputLabel 
                                        htmlFor="ice" 
                                        value={t('register.form.business_info.ice')} 
                                        className="text-gray-700 font-medium" 
                                    />
                                    <TextInput
                                        id="ice"
                        ...
                        {formData.type === 'citoyen' && (
                            <div className="space-y-4 p-5 border border-red-100 rounded-lg bg-red-50">
                                <h3 className="font-medium text-red-800">
                                    {t('register.form.citizen_info.title')}
                                </h3>
                                <div>
                                    <InputLabel 
                                        htmlFor="cin" 
                                        value={t('register.form.citizen_info.cin')} 
                                        className="text-gray-700 font-medium" 
                                    />
                                    <TextInput
                                        id="cin"
                        ...
                        {formData.type === 'agent_municipal' && (
                            <div className="space-y-4 p-5 border border-red-100 rounded-lg bg-red-50">
                                <h3 className="font-medium text-red-800">
                                    {t('register.form.agent_info.title')}
                                </h3>
                                <div>
                                    <InputLabel 
                                        htmlFor="matricule" 
                                        value={t('register.form.agent_info.employee_id')} 
                                        className="text-gray-700 font-medium" 
                                    />
                                    <TextInput
                                        id="matricule"
                        ...
                        {formData.type === 'etudiant' && (
                            <div className="space-y-4 p-5 border border-red-100 rounded-lg bg-red-50">
                                <h3 className="font-medium text-red-800">
                                    {t('register.form.student_info.title')}
                                </h3>
                                <div>
                                    <InputLabel 
                                        htmlFor="cne" 
                                        value={t('register.form.student_info.student_id')} 
                                        className="text-gray-700 font-medium" 
                                    />
                                    <TextInput
                                        id="cne"
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel 
                                    htmlFor="password" 
                                    value={t('register.form.password.password')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="password"
                            ...
                            <div>
                                <InputLabel 
                                    ...
                                    value={t('register.form.password.confirm_password')} 
                                    className="text-gray-700 font-medium" 
                                />
                                <TextInput
                                    id="password_confirmation"
                        ...
                        <div className="p-5 bg-gray-50 rounded-lg border border-gray-200">
                            <h3 className="font-medium text-gray-700 mb-3">
                                {t('register.form.summary.title')}
                            </h3>
                            <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 text-sm">
                                <div className="flex">
                                    <dt className="w-1/3 font-medium text-gray-500">
                                        {t('register.form.summary.name')}:
                                    </dt>
                                    <dd className="w-2/3 text-gray-800">
                                        {formData.nom || '-'} {formData.prenom || ''}
                                    </dd>
                                </div>
                                <div className="flex">
                                    <dt className="w-1/3 font-medium text-gray-500">
                                        {t('register.form.summary.email')}:
                                    </dt>
                                    <dd className="w-2/3 text-gray-800">{formData.email || '-'}</dd>
                                </div>
                                <div className="flex">
                                    <dt className="w-1/3 font-medium text-gray-500">
                                        {t('register.form.summary.phone')}:
                                    </dt>
                                    <dd className="w-2/3 text-gray-800">{formData.telephone || '-'}</dd>
                                </div>
                                <div className="flex">
                                    <dt className="w-1/3 font-medium text-gray-500">
                                        {t('register.form.summary.type')}:
                                    </dt>
                                    <dd className="w-2/3 text-gray-800 capitalize">
                                        {formData.type ? formData.type.replace('_', ' ') : '-'}
                                    </dd>
                                </div>
                                {formData.type === 'entreprise' && (
                                    <>
                                        <div className="flex">
                                            <dt className="w-1/3 font-medium text-gray-500">
                                                {t('register.form.business_info.company_name')}:
                                            </dt>
                                            <dd className="w-2/3 text-gray-800">{formData.nomEntreprise || '-'}</dd>
                                        </div>
                                        <div className="flex">
                                            <dt className="w-1/3 font-medium text-gray-500">
                                                {t('register.form.business_info.ice')}:
                                            </dt>
                                            <dd className="w-2/3 text-gray-800">{formData.ice || '-'}</dd>
                                        </div>
                                    </>
                                ...
                                {formData.type === 'citoyen' && (
                                    <div className="flex">
                                        <dt className="w-1/3 font-medium text-gray-500">
                                            {t('register.form.citizen_info.cin')}:
                                        </dt>
                                        <dd className="w-2/3 text-gray-800">{formData.cin || '-'}</dd>
                                    </div>
                                )}
                                {formData.type === 'agent_municipal' && (
                                    <div className="flex">
                                        <dt className="w-1/3 font-medium text-gray-500">
                                            {t('register.form.agent_info.employee_id')}:
                                        </dt>
                                        <dd className="w-2/3 text-gray-800">{formData.matricule || '-'}</dd>
                                    </div>
                                )}
                                {formData.type === 'etudiant' && (
                                    <div className="flex">
                                        <dt className="w-1/3 font-medium text-gray-500">
                                            {t('register.form.student_info.student_id')}:
                                        </dt>
                                        <dd className="w-2/3 text-gray-800">{formData.cne || '-'}</dd>
                                    </div>
                                )}
                            </dl>
                        </div>
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <label htmlFor="accept_terms" className="ml-2 text-sm text-gray-600">
                                <Trans 
                                    ...
                                    components={{ 1: <a href="#" className="text-red-700 hover:underline" /> }}
                                />
                            </label>
                        </div>
                        <InputError message={errors.accept_terms} className="mt-2 text-sm" />
                            ...
                            >
                                {processing ? (
                                    <div className="flex items-center">
                                        ...
                                        {t('register.form.buttons.processing')}
                                    </div>
                                ) : (
                                    t('register.form.buttons.create_account')
                                )}
                            </PrimaryButton>
                        </div>
                    </div>
