  ...
  return (
    <>
      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto py-4 px-6">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex space-x-8">
              <Link className="text-gray-700 hover:text-red-700 flex items-center" href="/">
                <Home className="mr-1 h-4 w-4" /> {t('header.home')}
              </Link>
              <Link className="text-gray-700 hover:text-red-700 flex items-center" href="/signalements">
                <AlertTriangle className="mr-1 h-4 w-4" /> {t('header.reports')}
              </Link>
              <Link className="text-gray-700 hover:text-red-700 flex items-center" href="/Carte">
                <Map className="mr-1 h-4 w-4" /> {t('header.map')}
              </Link>
              <Link className="text-gray-700 hover:text-red-700 flex items-center" href="/a-propos">
                <Info className="mr-1 h-4 w-4" /> {t('header.about')}
              </Link>
            ...
            <div className="flex space-x-3">
              ...
              <Link
                ...
                className="px-4 py-2 bg-red-700 text-white rounded-lg hover:bg-red-800 flex items-center"
              >
                <AlertTriangle className="mr-2 h-4 w-4" /> {t('header.report_problem')}
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h2 className="text-4xl font-bold mb-4 text-gray-800">{t('hero.title')}</h2>
            <p className="text-xl mb-6 text-gray-600">
              {t('hero.description')}
            </p>
            <div className="flex space-x-4">
              ...
              <Link
                ...
                className="px-6 py-3 bg-gray-100 text-gray-800 font-semibold rounded-lg hover:bg-gray-200 flex items-center"
              >
                {t('hero.how_it_works')} <ChevronRight className="ml-1 h-4 w-4" />
              </Link>
            </div>
          </div>
          <div className="md:w-1/2">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">{t('how_it_works.title')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">{t('how_it_works.steps.report.title')}</h3>
              <p className="text-gray-600">
                {t('how_it_works.steps.report.description')}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">{t('how_it_works.steps.locate.title')}</h3>
              <p className="text-gray-600">
                {t('how_it_works.steps.locate.description')}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">{t('how_it_works.steps.process.title')}</h3>
              <p className="text-gray-600">
                {t('how_it_works.steps.process.description')}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">{t('how_it_works.steps.resolve.title')}</h3>
              <p className="text-gray-600">
                {t('how_it_works.steps.resolve.description')}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-red-700 text-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-6">{t('stats.title')}</h2>
          <p className="text-xl text-center mb-12">
            {t('stats.subtitle')}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center bg-white text-gray-800 p-6 rounded-lg shadow-md">
              ...
              <p className="text-4xl font-bold mb-2">12,456</p>
              <p className="text-lg">{t('stats.reported')}</p>
            </div>
            ...
            <div className="text-center bg-white text-gray-800 p-6 rounded-lg shadow-md">
              ...
              <p className="text-4xl font-bold mb-2">8,721</p>
              <p className="text-lg">{t('stats.resolved')}</p>
            </div>
            ...
            <div className="text-center bg-white text-gray-800 p-6 rounded-lg shadow-md">
              ...
              <p className="text-4xl font-bold mb-2">5,280</p>
              <p className="text-lg">{t('stats.users')}</p>
            </div>
            ...
            <div className="text-center bg-white text-gray-800 p-6 rounded-lg shadow-md">
              ...
              <p className="text-4xl font-bold mb-2">72h</p>
              <p className="text-lg">{t('stats.avg_time')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">{t('testimonials.title')}</h2>
          
          {/* Les témoignages peuvent rester en dur ou être internationalisés selon les besoins */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Avis 1 */}
            <div className="bg-gray-50 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="flex items-center mb-4">
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-6 text-gray-800">{t('cta.title')}</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto text-gray-600">
            {t('cta.description')}
          </p>
          <Link
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <div className="flex items-center mb-4">
                <img src='/storage/img_desing/reparebladi-logo.svg' alt="Logo RepareBladi" className="h-10 w-10 mr-2" />
                <h3 className="text-xl font-bold text-red-800">{t('app.name')}</h3>
              </div>
              <p className="text-gray-600">
            ...
            {/* Liens */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-gray-800">{t('footer.quick_links')}</h4>
              <ul className="space-y-2">
                <li><Link className="text-gray-600 hover:text-red-500 transition-colors duration-300 flex items-center" href="/"><Home className="mr-2 h-4 w-4" /> {t('header.home')}</Link></li>
                <li><Link className="text-gray-600 hover:text-red-500 transition-colors duration-300 flex items-center" href="/signalements"><AlertTriangle className="mr-2 h-4 w-4" /> {t('header.reports')}</Link></li>
                <li><Link className="text-gray-600 hover:text-red-500 transition-colors duration-300 flex items-center" href="/carte"><Map className="mr-2 h-4 w-4" /> {t('header.map')}</Link></li>
                <li><Link className="text-gray-600 hover:text-red-500 transition-colors duration-300 flex items-center" href="/a-propos"><Info className="mr-2 h-4 w-4" /> {t('header.about')}</Link></li>
              </ul>
            </div>
            
            {/* Contact */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-gray-800">{t('footer.contact')}</h4>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
                  <Mail className="mr-2 h-4 w-4 text-red-800" />
                  contact@reparebladi.ma
            ...
            {/* Newsletter */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-gray-800">{t('footer.newsletter.title')}</h4>
