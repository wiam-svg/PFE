...
// import { MapPin, ArrowLeft, Clock, User, Phone, Mail, MessageSquare } from "lucide-react";
...
//                 <span
//                   className={`px-2 py-1 rounded ${priority === 'Urgent' ? 'bg-red-500 text-white' :
//                     priority === 'Moyenne' ? 'bg-orange-500 text-white' :
//                       'bg-blue-500 text-white'}`}
//                 >
//                   {priority} {/* Affiche la priorité calculée */}
//                 </span>
//                 <span
//                   className={`px-2 py-1 rounded ${intervention.resolution_status === 'rejetee' ? 'bg-red-100 text-red-600' : 'bg-gray-100 text-gray-600'}`}
//                 >
...
//               <div>
//                 <h3 className="font-semibold">{intervention.description_action}</h3>
//                 <p className="text-gray-600">{intervention.commentaire_admin}</p>
//               </div>

//               {/* Informations de localisation, date et équipe */}
//               <div className="flex items-center text-sm text-gray-500">
//                 <MapPin className="h-4 w-4 mr-2" />
//                 {signalement.adresse}, {signalement.ville}
//               </div>

//               <div className="flex items-center text-sm text-gray-500">
//                 <Clock className="h-4 w-4 mr-2" />
//                 Début: {intervention.dateDebut} - Fin: {intervention.dateFin}
//               </div>

//               <div className="flex items-center text-sm text-gray-500">
//                 <User className="h-4 w-4 mr-2" />
//                 {intervention.user.nom} {intervention.user.prenom}
//               </div>
//             </div>
//           </div>
...
//           {/* Signalement associé */}
//           {/* <div className="border rounded-lg p-6 shadow-sm">
//             <h2 className="text-lg font-semibold mb-4">Signalement associé</h2>
//             <Link
//               href={`/agent/reports/${signalement.id}`}
//               className="block p-4 rounded border hover:bg-gray-100 transition"
//             >
//               <h4 className="font-semibold">{signalement.titre}</h4>
...
//             <Link
//               href={`/signalement/${signalement.id}`}  // Lien vers le signalement complet dans la liste
//               className="block p-4 rounded border hover:bg-gray-100 transition"
//             >
//               <h4 className="font-semibold">{signalement.titre}</h4>
//               <p className="text-sm text-gray-600">{signalement.description}</p>
...
//           {/* Commentaire Admin */}
//           <div className="border rounded-lg p-6 shadow-sm">
//             <h2 className="text-lg font-semibold mb-4">Commentaire de l'admin</h2>

//             {intervention.commentaire_admin ? (
//               <div className="p-4 bg-gray-100 rounded text-gray-700 text-sm">
//                 {intervention.commentaire_admin}
//               </div>
//             ) : (
...
//         {/* Colonne contact : Affichage des informations de l'utilisateur qui a signalé */}
//         <div className="space-y-6">
//           <div className="border rounded-lg p-6 shadow-sm">
//             <h2 className="text-lg font-semibold mb-4">Contact du signaleur</h2>
...
//             </div>
//             <button
//               className="mt-4 w-full px-4 py-2 border rounded-lg text-sm hover:bg-gray-100 transition"
//             >
